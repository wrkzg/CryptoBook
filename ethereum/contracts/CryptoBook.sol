...
contract ContactFactory{
    ...
    function createContact(string memory _telegram, string memory _discord) onlyNewRecords public {
        
        ownerToContact[msg.sender] = address(new Contact(msg.sender, _telegram, _discord ));
    }

    function createContact(string memory _telegram) onlyNewRecords public {
        
        ownerToContact[msg.sender] = address(new Contact(msg.sender, _telegram, "" ));
    }
}
